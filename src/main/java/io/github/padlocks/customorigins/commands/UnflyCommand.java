...
public class UnflyCommand {
    public static void register(CommandDispatcher<ServerCommandSource> dispatcher) {
        LiteralArgumentBuilder<ServerCommandSource> literal = CommandManager.literal("unfly");
        literal.requires(Command.IS_OP)
    ...
    public static int execute(CommandContext<ServerCommandSource> ctx,
        ...
        if (player.abilities.allowFlying) {
            Pal.revokeAbility(player, VanillaAbilities.ALLOW_FLYING, FlightEffect.FLIGHT_POTION);
        }
