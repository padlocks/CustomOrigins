package io.github.padlocks.customorigins.entity;
...
public class AttackThingsThatAreNotBeesGoal extends FollowTargetGoal<LivingEntity> {
    ...
    public AttackThingsThatAreNotBeesGoal(BeeEntity entity) {
    ...
    protected void findClosestTarget() {
        this.targetEntity = this.mob.world.getClosestEntity(this.targetClass, this.targetPredicate, this.mob,
                this.mob.getX(), this.mob.getY(), this.mob.getZ(), this.getSearchBox(this.getFollowRange()));
    }
