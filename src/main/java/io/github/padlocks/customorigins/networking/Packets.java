...
public final class Packets {
    ...
    public static Packet<?> newSpawnPacket(final Entity entity) {
        ...
        return ServerSidePacketRegistry.INSTANCE.toPacket(NetworkingConstants.SPAWN, bytes);
    }
    ...
    public static <T extends Entity> void dispatchToAllWatching(final T entity, final Function<T, Packet<?>> packet) {
        PlayerStream.watching(entity).map(player -> ((ServerPlayerEntity) player).networkHandler)
