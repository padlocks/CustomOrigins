...
public class ModPotion extends Potion {
    ...
    public static class ModPotionTimed extends ModPotion {
        ...
        public static ModPotionTimed generateAll(String name, StatusEffect statusEffect, int lengthNormal,
                int lengthExtended, int lengthEmpowered) {
        ...
        public static ModPotionTimed generateWithLengthened(String name, StatusEffect statusEffect, int lengthNormal,
                int lengthExtended) {
            ModPotionTimed base = new ModPotionTimed(name, statusEffect, lengthNormal, 0);
