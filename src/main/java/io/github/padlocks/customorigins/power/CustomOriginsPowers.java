...
public class CustomOriginsPowers {
        ...
        public static final PowerType<Power> TRANSLUCENT = new PowerTypeReference(new Identifier("customorigins", "translucent"));
        public static final PowerType<Power> UNDEAD = new PowerTypeReference(new Identifier("customorigins", "undead"));
        public static final PowerType<Power> UNDEAD_RESISTANCE = new PowerTypeReference(new Identifier("customorigins", "undead_resistance"));
        public static final PowerType<Power> ENTITY_GROUP = new PowerTypeReference(new Identifier("customorigins", "entity_group"));
        public static final PowerType<Power> EXTRA_SOUL_SPEED = new PowerTypeReference(new Identifier("customorigins", "extra_soul_speed"));
